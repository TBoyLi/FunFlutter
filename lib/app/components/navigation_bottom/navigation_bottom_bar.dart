...
class _BottomBar3State extends State<NavigationBottomBar>
  ...
  var primaryColor = Colors.transparent;
            ...
            child: AnimatedBuilder(
              ...
              child: PhysicalShape(
                ...
                child: Row(
                  ...
                  children: [
                    menuItem('分享文章', Icons.live_tv),
                    line(),
                    menuItem('分享项目', Icons.account_tree_outlined),
                  ],
                ),
              ),
            ),
