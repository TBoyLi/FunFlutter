...
import 'package:fun_flutter/app/components/verify/r_dotted_line_border.dart';

/// 验证widget
/// return
/// [true] 成功
/// [false] 失败
class SafeVerity extends StatefulWidget {
  final Function lister;

  const SafeVerity({required this.lister});

  @override
  _SafeVerityState createState() => _SafeVerityState();
}

class _SafeVerityState extends State<SafeVerity> with TickerProviderStateMixin {
  /// 半径
          ...
          AnimatedBuilder(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Image.asset('assets/icons/ic_safe.jpg'),
              ),
            ),
          ),
        ],
